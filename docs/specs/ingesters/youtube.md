...
| `rag_youtube_whisper_model` | 文字列 | `config.toml` | `"base"` | Whisper モデル名 | faster-whisper のモデル名 |
| `rag_youtube_whisper_device` | 文字列 | `config.toml` | `"cuda"` | `"cuda"` / `"cpu"` | faster-whisper のデバイス |
